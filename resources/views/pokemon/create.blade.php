...
<div class="createformp">
    <div class="createformp1">
        <form action="{{ url('pokemon') }}" method="post" class="formc1">
        @csrf
        ...
        <input type="number" name="height" id="height"/>
          <br>
             ...
             <input type="submit" value="submit" class="pokemonsubmit"  />
           
        </form>
        
        <form action="{{ url('uploadDragDrop') }}" method="POST" class="form" id="form" enctype="multipart/form-data">
            @csrf
            <div class="form-content">
            <!-- Input traducional para la subida de archivos -->
            <input type="file" name="file" id="form-input_file" class="form-input_file hide">
            ...
            <p class="drop-zone-text">Arrastra tus archivos o haz click para subir archivos</p>
            </div>
            <!-- Botón de submit -->
            <input type="submit" value="Enviar Archivos" id="form-button" class="form-button">
